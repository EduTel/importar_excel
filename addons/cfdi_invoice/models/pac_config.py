...
class PacConfig(models.Model):
    ...
    name = fields.Char('Identificador del Registro', required=True,
                       help="Ponga un nombre a este registro para identificarlo de manera simple.")
    ...
    acuse = fields.Char('Función para descargar acuse', required=True)
    ...
    def cancelar_cfdi(self, invoice, uuid):
        user = self.user
        password = self.password
